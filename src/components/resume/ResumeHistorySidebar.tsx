  ...
  return (
    <>
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip="Build roadmap">
                <a href="/prepareAI"><Sparkles /><span>Build roadmap</span></a>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
        </SidebarFooter>
      ...
      <div className="fixed left-2 top-[4.5rem] z-30 md:hidden">
        <SidebarTrigger className="h-9 w-9 rounded-full border bg-background/90 shadow-sm backdrop-blur" aria-label="Open resume history" />
      </div>
    </>
  );
}
