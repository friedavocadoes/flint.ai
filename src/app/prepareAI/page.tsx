        ...
        <div className="flex flex-col p-4 md:p-6 lg:p-8 !pt-14 pb-20 w-full max-w-[1400px] mx-auto">
          ...
          <div className="md:hidden flex items-center justify-between gap-2 mb-4">
            <Sheet open={mobileHistoryOpen} onOpenChange={setMobileHistoryOpen}>
              ...
              <SheetContent
                side="left"
                className="w-[86vw] max-w-[320px] p-0 flex flex-col"
              >
                    ...
                    <div className="flex flex-col gap-1">
                      {loading ? (
                        ...
                        <p className="px-2 py-6 text-center text-xs text-muted-foreground">
                          No roadmaps yet. Forge your first one.
                        </p>
                      ) : (
          ...
          {!selectedChat ? (
            <div className="w-full">
              <div className="max-w-3xl mx-auto text-center mb-6">
                ...
                <p className="text-sm md:text-[15px] text-muted-foreground mt-3 max-w-[62ch] mx-auto leading-relaxed">
                  3 steps, 2 minutes. Tell us your target country, where you are
                  now, and what you’re chasing — we’ll forge a market-real
                  roadmap with honest timeline, salary check & visa notes.
                </p>
                {chats.length > 0 && !loading && (
                  <p className="text-xs text-muted-foreground mt-2">
                    You have {chats.length} roadmap{chats.length !== 1 && "s"} •
                    pick one from History or forge a new one
                  </p>
                )}
              </div>
